...
const SHEET_CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQq1iUlQaGtv1X3c1H5yTnA1QGs5otS1SWOWe6cSuDGM3Eb7GEGxMskB-vflre7FDhW9sHxnVRh2k2f/pub?output=csv"; // ⭐ 請將您的 Google 試算表 CSV 網址貼在引號內
  ...
  try {
    ...
    for (let i = 1; i < rows.length; i++) {
      ...
      newProducts.push({
        ...
        image: parseImageUrl(rowData["image"]),
        detailImage: parseImageUrl(rowData["detailImage"]),
        tag: rowData["tag"],
